...
class ActivityLogRepository {
  ...
  final List<ActivityLog> _activityLogs = [
    // Recent logs (Today - October 22, 2024)
    ActivityLog(
      no: 1,
    ...
    ActivityLog(
      ...
      aktor: 'Bu RT',
      tanggal: DateTime(2024, 10, 22, 13, 15),
      avatar: 'BR',
    ),
    ActivityLog(
      no: 3,
      ...
      aktor: 'Admin Jawara',
      tanggal: DateTime(2024, 10, 22, 11, 45),
      avatar: 'AJ',
    ),
    ActivityLog(
      no: 4,
      ...
      aktor: 'Admin Jawara',
      tanggal: DateTime(2024, 10, 22, 10, 20),
      avatar: 'AJ',
    ),
    ActivityLog(
      no: 5,
      ...
      aktor: 'Pak Budi',
      tanggal: DateTime(2024, 10, 22, 09, 00),
      avatar: 'PB',
    ),

    // Yesterday (October 21, 2024)
    ActivityLog(
      no: 6,
      deskripsi:
          'Menambahkan kegiatan: Bimbel Gratis SD untuk tanggal 26 Oktober',
      aktor: 'Pak Joko',
      tanggal: DateTime(2024, 10, 21, 20, 30),
      avatar: 'PJ',
    ),
    ActivityLog(
      no: 7,
      ...
      aktor: 'Bu Rina',
      tanggal: DateTime(2024, 10, 21, 18, 45),
      avatar: 'BR',
    ),
    ActivityLog(
      no: 8,
      ...
      aktor: 'Admin Jawara',
      tanggal: DateTime(2024, 10, 21, 16, 00),
      avatar: 'AJ',
    ),
    ActivityLog(
      no: 9,
      ...
      aktor: 'Bu Sari',
      tanggal: DateTime(2024, 10, 21, 14, 20),
      avatar: 'BS',
    ),
    ActivityLog(
      no: 10,
      ...
      aktor: 'Bu Sari',
      tanggal: DateTime(2024, 10, 21, 11, 30),
      avatar: 'BS',
    ),
    ...
    ActivityLog(
      ...
      aktor: 'Bu Sari',
      tanggal: DateTime(2024, 10, 20, 19, 00),
      avatar: 'BS',
    ),
    ActivityLog(
      no: 12,
      ...
      aktor: 'Admin Jawara',
      tanggal: DateTime(2024, 10, 20, 15, 45),
      avatar: 'AJ',
    ),
    ActivityLog(
      no: 13,
      ...
      aktor: 'Pak Wahyu',
      tanggal: DateTime(2024, 10, 20, 13, 20),
      avatar: 'PW',
    ),
    ActivityLog(
      no: 14,
      ...
      aktor: 'Bu RT',
      tanggal: DateTime(2024, 10, 20, 10, 00),
      avatar: 'BR',
    ),
    ActivityLog(
      no: 15,
      ...
      aktor: 'Admin Jawara',
      tanggal: DateTime(2024, 10, 20, 08, 30),
      avatar: 'AJ',
    ),
    ...
    ActivityLog(
      ...
      aktor: 'Bu Sari',
      tanggal: DateTime(2024, 10, 19, 16, 15),
      avatar: 'BS',
    ),
    ActivityLog(
      no: 17,
      ...
      aktor: 'Bu Fatimah',
      tanggal: DateTime(2024, 10, 19, 14, 00),
      avatar: 'BF',
    ),
    ActivityLog(
      no: 18,
      ...
      aktor: 'Admin Jawara',
      tanggal: DateTime(2024, 10, 19, 11, 30),
      avatar: 'AJ',
    ),
    ActivityLog(
      no: 19,
      ...
      aktor: 'Pak Budi',
      tanggal: DateTime(2024, 10, 19, 09, 45),
      avatar: 'PB',
    ),
    ActivityLog(
      no: 20,
      ...
      aktor: 'Pak Bambang',
      tanggal: DateTime(2024, 10, 19, 07, 00),
      avatar: 'PB',
    ),
    ...
    ActivityLog(
      ...
      aktor: 'Pak Ahmad',
      tanggal: DateTime(2024, 10, 18, 19, 30),
      avatar: 'PA',
    ),
    ActivityLog(
      no: 22,
      ...
      aktor: 'Bu Endah',
      tanggal: DateTime(2024, 10, 18, 16, 00),
      avatar: 'BE',
    ),
    ActivityLog(
      no: 23,
      ...
      aktor: 'Bu Sari',
      tanggal: DateTime(2024, 10, 18, 13, 20),
      avatar: 'BS',
    ),
    ActivityLog(
      no: 24,
      ...
      aktor: 'Pak Wahyu',
      tanggal: DateTime(2024, 10, 18, 06, 30),
      avatar: 'PW',
    ),
    ...
    ActivityLog(
      ...
      aktor: 'Pak Joko',
      tanggal: DateTime(2024, 10, 17, 20, 00),
      avatar: 'PJ',
    ),
    ActivityLog(
      no: 26,
      ...
      aktor: 'Bu RT',
      tanggal: DateTime(2024, 10, 17, 17, 45),
      avatar: 'BR',
    ),
    ActivityLog(
      no: 27,
      ...
      aktor: 'Admin Jawara',
      tanggal: DateTime(2024, 10, 17, 15, 00),
      avatar: 'AJ',
    ),
    ActivityLog(
      no: 28,
      ...
      aktor: 'Admin Jawara',
      tanggal: DateTime(2024, 10, 17, 12, 30),
      avatar: 'AJ',
    ),
    ActivityLog(
      no: 29,
      ...
      aktor: 'Bu Sari',
      tanggal: DateTime(2024, 10, 17, 10, 15),
      avatar: 'BS',
    ),
    ActivityLog(
      no: 30,
      ...
      aktor: 'Pak Joko',
      tanggal: DateTime(2024, 10, 17, 08, 00),
      avatar: 'PJ',
    ),
    ...
    ActivityLog(
      ...
      aktor: 'Admin Jawara',
      tanggal: DateTime(2024, 10, 16, 18, 20),
      avatar: 'AJ',
    ),
    ActivityLog(
      no: 32,
      ...
      aktor: 'Pak Wahyu',
      tanggal: DateTime(2024, 10, 16, 15, 30),
      avatar: 'PW',
    ),
    ActivityLog(
      no: 33,
      ...
      aktor: 'Bu RT',
      tanggal: DateTime(2024, 10, 16, 13, 00),
      avatar: 'BR',
    ),
    ActivityLog(
      no: 34,
      ...
      aktor: 'Admin Jawara',
      tanggal: DateTime(2024, 10, 16, 10, 45),
      avatar: 'AJ',
    ),
    ActivityLog(
      no: 35,
      ...
      aktor: 'Pak Budi',
      tanggal: DateTime(2024, 10, 16, 08, 15),
      avatar: 'PB',
    ),
  ];
