...
class ActivityRepository {
  ...
  final List<Activity> _activities = [
    ...
    // Today's Activities (October 22, 2024)
    Activity(
      id: 6,
      nama: 'Senam Pagi Lansia',
      kategori: 'Kesehatan & Olahraga',
      penanggungJawab: 'Bu Endah',
      tanggal: DateTime(2024, 10, 22),
      waktu: '06:30',
    ...
    // Upcoming Activities (Late October - November 2024)
    Activity(
      id: 8,
      nama: 'Pengajian Rutin Bapak-bapak',
      kategori: 'Keagamaan',
      penanggungJawab: 'Pak Ahmad',
      tanggal: DateTime(2024, 10, 23),
      waktu: '19:30',
